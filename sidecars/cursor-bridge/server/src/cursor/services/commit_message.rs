...
/// Forwards the request to Cursor's official backend.
///
/// Tab routing used to be able to redirect this to a third-party service. That
/// subsystem is gone, so "direct" now always means Cursor itself.
